...
MySQL - 10.2.12-MariaDB-log : Database - tp_data
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`tp_data` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_german2_ci */;
...
insert  into `admin`(`admin_id`,`username`,`pwd`,`group_id`,`email`,`realname`,`tel`,`ip`,`add_time`,`mdemail`,`is_open`,`avatar`) values (1,'admin','21232f297a57a5a743894a0e4a801fc3',1,'150598682915@qq.com','','15059862915','127.0.0.1',1482132862,'0',1,'/uploads/20201020/e3e76fc12905110fd53a86e715aadf9c.png');
...
insert  into `article_tags`(`id`,`tag_id`,`article_id`) values (1,1,45),(2,2,45),(3,1,36),(4,3,36),(5,4,36),(6,5,43),(7,6,40),(8,7,17),(9,8,17);
...
insert  into `auth_group`(`group_id`,`title`,`status`,`rules`,`addtime`) values (1,'超级管理员',1,'0,1,2,270,15,16,119,120,121,145,17,149,116,117,118,151,181,18,108,114,112,109,110,111,3,5,126,127,128,4,230,232,129,189,190,193,192,240,239,241,243,244,245,242,246,7,9,14,234,13,235,236,237,238,27,29,161,163,164,162,38,167,182,169,166,28,48,247,248,31,32,249,250,251,45,170,171,175,174,173,46,176,183,179,178,265,196,197,202,198,252,253,254,255,256,203,205,204,257,272,206,207,212,208,213,258,259,260,261,262,209,215,214,263,273,267,269,',1465114224),(2,'管理员',1,'0,1,2,270,15,16,145,17,181,18,111,3,5,127,128,4,129,189,190,239,241,242,7,9,14,234,13,235,236,237,27,29,161,163,164,162,38,167,182,169,166,28,48,31,32,45,174,46,179,196,197,202,252,203,204,272,206,207,212,208,260,209,215,267,269,',1465114224),(3,'商品管理员',1,'27,29,161,163,164,162,38,167,182,169,166,',1465114224);
...
insert  into `category`(`id`,`catname`,`catdir`,`parentdir`,`pid`,`moduleid`,`module`,`arrparentid`,`arrchildid`,`type`,`title`,`keywords`,`description`,`sort`,`ishtml`,`ismenu`,`hits`,`image`,`child`,`url`,`template_list`,`template_show`,`pagesize`,`readgroup`,`listtype`,`lang`,`is_show`) values (1,'最新动态','news','',0,2,'article','0','1',0,'最新动态','最新动态','最新动态',4,0,1,0,'',1,'','article_list','article_show',0,'1,2,3',0,0,0),(4,'系统操作','system','',0,3,'picture','0','4',0,'CLTPHP系统操作','CLTPHP系统操作,CLTPHP,CLTPHP内容管理系统','CLTPHP系统操作,CLTPHP,CLTPHP内容管理系统',2,0,1,0,'',0,'','','',0,'1,2',0,0,0),(8,'联系我们','contact','',0,1,'page','0','8',0,'联系我们','联系我们','联系我们',7,0,1,0,'',0,'','page_show_contace','page_show_contace',0,'1,2',0,0,0),(7,'精英团队','team','',0,6,'team','0','7',0,'精英团队','精英团队','精英团队',5,0,1,0,'',0,'','','',0,'1,2',0,0,0);
...
insert  into `debris_type`(`id`,`title`,`sort`) values (1,'【首页】中部碎片',1);
...
insert  into `donation`(`id`,`name`,`money`,`addtime`) values (3,'高飞','10.00','1466566714'),(4,'王磊','5.50','1466566733'),(5,'一匹忧郁的狼','11.11','1466566780'),(6,'神盾','50.00','1467517788'),(7,'赵云的枪','20.00','1469582594'),(8,'王@楠','5.00','1473155340'),(9,'王宁','10.00','1473647377'),(11,'幽鸣','100.00','1483080600');
...
insert  into `feast`(`id`,`title`,`open`,`sort`,`addtime`,`feast_date`,`type`) values (2,'圣诞节',1,50,'1513304012','12-25',1),(3,'中秋节',1,2,'1513317857','07-12',1),(4,'七夕',1,50,'1532420762','07-24',1);
...
CREATE TABLE `feast_element` (
  ...
  `title` varchar(120) DEFAULT NULL COMMENT '标题',
  `css` text DEFAULT NULL COMMENT 'CSS',
  `js` text DEFAULT NULL COMMENT 'JS',
...
insert  into `message`(`message_id`,`title`,`tel`,`addtime`,`open`,`ip`,`content`,`name`,`email`) values (92,'呵呵','','1528851199',0,'127.0.0.1','为什么还不更新？','chichu','1109305987@qq.com'),(93,'11','','1530629400',0,'127.0.0.1','11','11','11'),(94,'11','','1530777448',0,'127.0.0.1','11','11','11'),(95,'11','','1542781283',0,'127.0.0.1','<p>111</p>','11','110@qq.com');
...
insert  into `module`(`id`,`title`,`name`,`description`,`type`,`issystem`,`listfields`,`sort`,`status`) values (1,'单页模型','page','单页面',1,0,'*',0,1),(2,'文章模型','article','新闻文章',1,0,'*',0,1),(3,'图片模型','picture','图片展示',1,0,'*',0,1),(4,'产品模型','product','产品展示',1,0,'*',0,1),(5,'下载模型','download','文件下载',1,0,'*',0,1),(6,'团队模型','team','员工展示',1,0,'*',0,1);
...
insert  into `page`(`id`,`title`,`title_style`,`thumb`,`hits`,`status`,`userid`,`username`,`sort`,`createtime`,`updatetime`,`lang`,`content`,`template`) values (8,'联系我们','color:;font-weight:normal;','',16,'1',0,'',0,1499765407,0,0,'您的支持是我们一往无前的无限动力，非常荣幸在 成长的道路上有您的陪伴！！！','0');
...
insert  into `plugin`(`code`,`name`,`version`,`author`,`config`,`config_value`,`desc`,`status`,`type`,`icon`,`bank_code`,`scene`) values ('qq','QQ登陆','1.0','CLTPHP','a:3:{i:0;a:4:{s:4:\"name\";s:7:\"APP_KEY\";s:5:\"label\";s:5:\"appid\";s:4:\"type\";s:4:\"text\";s:5:\"value\";s:0:\"\";}i:1;a:4:{s:4:\"name\";s:10:\"APP_SECRET\";s:5:\"label\";s:6:\"appkey\";s:4:\"type\";s:4:\"text\";s:5:\"value\";s:0:\"\";}i:2;a:4:{s:4:\"name\";s:8:\"CALLBACK\";s:5:\"label\";s:12:\"回调地址\";s:4:\"type\";s:4:\"text\";s:5:\"value\";s:40:\"http://demo.com/user/callback/qq?type=qq\";}}','a:3:{s:7:\"APP_KEY\";s:0:\"\";s:10:\"APP_SECRET\";s:0:\"\";s:8:\"CALLBACK\";s:40:\"http://demo.com/user/callback/qq?type=qq\";}','QQ登陆插件 ',0,'login','logo.png','s:0:\"\";',0),('changyan','畅言评论','1.0','CLTPHP','a:3:{i:0;a:4:{s:4:\"name\";s:6:\"app_id\";s:5:\"label\";s:6:\"app_id\";s:4:\"type\";s:4:\"text\";s:5:\"value\";s:0:\"\";}i:1;a:4:{s:4:\"name\";s:7:\"app_key\";s:5:\"label\";s:7:\"app_key\";s:4:\"type\";s:4:\"text\";s:5:\"value\";s:0:\"\";}i:2;a:4:{s:4:\"name\";s:6:\"config\";s:5:\"label\";s:6:\"config\";s:4:\"type\";s:4:\"text\";s:5:\"value\";s:0:\"\";}}','a:6:{s:7:\"APP_KEY\";s:0:\"\";s:10:\"APP_SECRET\";s:0:\"\";s:8:\"CALLBACK\";s:40:\"http://demo.com/user/callback/qq?type=qq\";s:6:\"app_id\";s:0:\"\";s:7:\"app_key\";s:0:\"\";s:6:\"config\";s:0:\"\";}','畅言评论插件 ',0,'msg','logo.png','s:0:\"\";',0);
...
insert  into `posid`(`id`,`name`,`sort`) values (1,'首页推荐',0),(2,'当前分类推荐',0);
...
CREATE TABLE `question` (
  ...
  `typeid` int(3) DEFAULT NULL COMMENT 'questiontyp id',
  `question` varchar(200) COLLATE utf8mb4_german2_ci DEFAULT NULL,
  `questionurl` varchar(255) COLLATE utf8mb4_german2_ci DEFAULT NULL,
  `answerurl` varchar(255) COLLATE utf8mb4_german2_ci DEFAULT NULL,
  `is_lock` int(1) DEFAULT 0 COMMENT '0显示，1删除',
  `level` int(1) DEFAULT NULL COMMENT '1:简单;2难...',
...
insert  into `question`(`id`,`typeid`,`question`,`questionurl`,`answerurl`,`is_lock`,`level`,`addtime`) values (2,2,'[考查功的正负判断]','/uploads/20201031/578c663242ff51d2bec0a22525edd603.docx','/uploads/20201031/aca7dd0ccba87e7edede4338263202f9.docx',0,1,1604134393),(3,1,'变力功的求解方法与技巧多选择','/uploads/20201031/f9e758db7dd7b1f2a0b6da361f86ec94.docx','/uploads/20201031/1a1e145357bfa66dffae8dc719a871ea.docx',0,1,1604134046),(4,1,'考查F­x图像求功','/uploads/20201031/43c31b20c1592aae405dde814762f89e.docx','/uploads/20201031/677da7cae4dcedf0ba1c662caeb931af.docx',0,2,1604151756),(5,1,'考查化变力为恒力求功','/uploads/20201031/61361e354e28e2dae01142a98238a979.docx','/uploads/20201031/40255c41b0d5c46e8aa1734ee68223a1.docx',0,1,1604134202);
...
CREATE TABLE `question_level` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='难度等级';

/*Data for the table `question_level` */

insert  into `question_level`(`id`,`level_name`) values (1,'第一级'),(2,'第二级'),(3,'第三级'),(4,'第四级'),(5,'第五级');
...
CREATE TABLE `questiontype` (
  ...
  `status` int(1) DEFAULT 1 COMMENT '1显示，0不显示',
...
insert  into `questiontype`(`id`,`title`,`status`,`sort`) values (1,'第五单元',1,1),(2,'第七单元',1,5),(3,'第三单元',1,4);
...
insert  into `role`(`id`,`name`,`status`,`remark`,`pid`,`sort`) values (1,'超级管理员',1,'超级管理',0,0),(2,'普通管理员',1,'普通管理员',0,0),(3,'注册用户',1,'注册用户',0,0),(4,'游客',1,'游客',0,0);
...
insert  into `system`(`id`,`name`,`domain`,`title`,`key`,`des`,`bah`,`copyright`,`ads`,`tel`,`email`,`logo`,`mobile`,`code`) values (1,'测试题型','http://demo.com/','测试题型','测试题型','测试题型','闽ICP备14016166号-4','2015-2020','泉州市大洋百货','15012345678','386378183@qq.com','/uploads/20201031/e7b98c060b1b747335d9d832eca29346.png','open','open');
...
insert  into `tags`(`id`,`name`,`nums`,`hits`) values (1,'cltphp',2,5),(2,'时间',1,4),(3,'CLTPHP',1,1),(4,'更新',1,0),(5,'CSS',1,0),(6,'邮箱验证',1,0),(7,'PC端',1,0),(8,'手机端',1,0);
...
insert  into `team`(`id`,`title`,`title_style`,`thumb`,`hits`,`status`,`userid`,`username`,`sort`,`createtime`,`updatetime`,`lang`,`catid`,`info`,`template`) values (1,'快乐的毛豆豆—前端工程师','color:rgb(57, 61, 73);font-weight:normal;','/uploads/20180613/27f4cfe5854eb4cfdfd87399a60c7cbd.jpg',0,1,1,'admin',0,1499764958,1528876606,0,7,'<p>2年设计、3年前端，从菜鸟到老手，从未停止追求细节的完美。注重细节，追求完美已成为习惯。</p>',NULL),(2,'褫憷—软件工程师','color:rgb(57, 61, 73);font-weight:normal;','/uploads/20180613/7d4aaaf4c86aac002184dace64cf179e.jpg',1,1,1,'admin',0,1499765015,1528876594,0,7,'<p>5年开发、3年前端，不断的自我建设，来保持向上的状态。</p>',NULL);
...
insert  into `user_level`(`level_id`,`level_name`,`sort`,`bomlimit`,`toplimit`) values (1,'注册会员',1,0,500),(2,'铜牌会员',2,501,1000),(3,'白银会员',3,1001,2000),(4,'黄金会员',4,2001,3500),(5,'钻石会员',5,3501,5500),(6,'超级VIP',6,5500,99999);
...
CREATE TABLE `user_question` (
  ...
  `questions` varchar(500) DEFAULT NULL COMMENT '题id',
  `userid` int(6) DEFAULT NULL,
  `num` int(5) DEFAULT NULL COMMENT '总题数',
  `addtime` int(10) DEFAULT NULL,
...
insert  into `users`(`id`,`email`,`password`,`paypwd`,`sex`,`birthday`,`reg_time`,`last_login`,`last_ip`,`qq`,`mobile`,`mobile_validated`,`oauth`,`openid`,`unionid`,`avatar`,`province`,`city`,`district`,`email_validated`,`username`,`level`,`is_lock`,`token`,`sign`,`status`) values (1,'1109305987@qq.com','',NULL,1,0,1516075631,0,'','','44311',0,'',NULL,NULL,'/uploads/20180613/fcb729987d8e9339bd9b2e85c85f3028.jpg',24,311,2599,0,'chichu',1,1,'','不要应为走得太远，就忘了当初为什么出发！','hide'),(2,'','e10adc3949ba59abbe56e057f20f883e',NULL,0,0,1542781390,0,'','','18092591522',1,'',NULL,NULL,NULL,0,0,0,0,'chichu',1,1,'','','hide'),(3,'xiao@qq.com','e10adc3949ba59abbe56e057f20f883e',NULL,1,0,1603898904,0,'','','',0,'',NULL,NULL,'/uploads/20201031/4a51bce134c22382c803c9fbe246550b.png',0,0,0,1,'xiaomaing',2,0,'','','hide');
...
insert  into `wx_default_replay`(`id`,`instance_id`,`reply_media_id`,`sort`,`create_time`,`modify_time`) values (3,0,4,0,1528695059,0);
...
insert  into `wx_follow_replay`(`id`,`instance_id`,`reply_media_id`,`sort`,`create_time`,`modify_time`) values (2,0,1,0,1528695047,0);
...
insert  into `wx_key_replay`(`id`,`instance_id`,`key`,`match_type`,`reply_media_id`,`sort`,`create_time`,`modify_time`) values (2,0,'你好',1,3,0,1528696514,0);
...
insert  into `wx_media`(`media_id`,`title`,`instance_id`,`type`,`sort`,`create_time`,`modify_time`) values (1,'欢迎您来到CLTPHP官方公众号大世界！',0,'1',0,1512551413,0),(2,'你好，欢迎来到CLTPHP的世界！',0,'1',0,1512550726,0),(3,'CLTPHP内容管理系统',0,'2',0,1512550547,0),(4,'CLTPHP内容管理系统5.2.2发布',0,'3',0,1528694363,0),(5,'CLTPHP操作开发手册已完全更新',0,'2',0,1528694392,0),(6,'1111',0,'1',0,1528694379,0);
...
insert  into `wx_menu`(`menu_id`,`instance_id`,`menu_name`,`ico`,`pid`,`menu_event_type`,`media_id`,`menu_event_url`,`hits`,`sort`,`create_date`,`modify_date`) values (1,0,'官网','',0,2,3,'http://www.cltphp.com/',0,1,1512442512,0),(2,0,'手册','',0,2,5,'http://www.cltphp.com/',0,2,1512442543,0),(3,0,'论坛','',0,1,4,'http://bbs.cltphp.com/',0,3,1512547727,0),(4,0,'百度','',3,1,0,'http://www.baodu.com',0,1,1542783759,0);
...
insert  into `wx_mp`(`id`,`instance_id`,`key`,`value`,`desc`,`is_use`,`create_time`,`modify_time`,`qrcode`) values (1,0,'WCHAT','{\"APP_KEY\":\"\",\"APP_SECRET\":\"\",\"AUTHORIZE\":\"http:\\/\\/b2c1.01.niushop.com.cn\",\"CALLBACK\":\"http:\\/\\/b2c1.01.niushop.com.cn\\/wap\\/Login\\/callback\"}','微信',0,1488350947,1497105440,''),(2,0,'SHOPWCHAT','{\"appid\":\"dfdsfdsf90bc7b7a\",\"appsecret\":\"e5147ce07128asdfds222f628b5c3fe1af2ea5797\",\"token\":\"dffdf\",\"qrcode\":\"\\/uploads\\/20190308\\/64e2362d3547682c437e8c72817ed0f5.png\",\"file\":\"\"}','',1,1497088090,1552013585,'/uploads/20190308/64e2362d3547682c437e8c72817ed0f5.png');
